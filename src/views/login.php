        ...
        <div class="div-login" <?= isset($message) && $message !== '' ? 'style="height: 25em;"' : '' ?> <?= count($errors) === 1 ? 'style="height: 411px;"' : '' ?> <?= count($errors) === 2 ? 'style="height: 441px;"' : '' ?>>
            <form action="#" method="post">
                <div class="mb-3">
                    ...
                    <?php endif ?>
                    <input type="text" <?= isset($errors['email']) ? 'style="border-width: 5px;"' : '' ?> class="form-control <?= isset($errors['email']) ? "is-invalid " : '' ?>" name="email" id="email" placeholder="Digite o seu email" value="<?= isset($_POST['email']) ? $_POST['email'] : '' ?>">
